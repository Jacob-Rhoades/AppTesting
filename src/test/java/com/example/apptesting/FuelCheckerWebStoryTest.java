...
public class FuelCheckerWebStoryTest {
    ...
    public void test_T5() {
        ...
        assertTrue(bodyText.contains("Standard tank capacity: 1200 litres."), "Standard tank capacity text is missing.");
        assertTrue(bodyText.contains("High safety tank capacity: 800 litres."), "High safety tank capacity text is missing.");
    ...
    public void test_T6() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated( By.id("body")));
        String bodyText = driver.findElement( By.id("body")).getText();
        assertTrue(bodyText.contains("Thank you for using FuelChecker."), "Thank you is missing.");
    }
